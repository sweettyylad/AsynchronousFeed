...
- **DoD:** все чекбоксы REQUIREMENTS §1–2 проставлены, кроме R13 (публичная ссылка закрывается шагом 14); lint/tests/build зелёные; в коде нет console.log, секретов, TODO.
