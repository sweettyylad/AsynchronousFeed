...
> **Статус:** задеплоено. Публичная ссылка: http://45.9.117.39:3000
...
Локально приложение доступно на http://localhost:3000 (миграции применяются автоматически при старте).

Публичный деплой: http://45.9.117.39:3000
